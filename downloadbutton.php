...
<body>
        ...
        <br/><br/><br/>
	<form class="form" action="export1.php" method="post" enctype="multipart/form-data">
		<center><input class="btn btn-success" type="submit" name="export" value="Download Excel"></center>			
