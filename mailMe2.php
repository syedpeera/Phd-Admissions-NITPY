...
try {
    ...
    $mail->addAddress('peeraandroid.123@gmail.com', 'Applicant');     // Add a recipient
    ...
    $mail->Body    = 'you have registered your application no is <b>yes it is hidden</b>';
    $mail->AltBody = 'you have registered your application no is 1343525';
...
<?php 
echo "Check your mail for application number";
 ?>
</body>
</html>
