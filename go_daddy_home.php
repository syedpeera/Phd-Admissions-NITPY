...
<body>
	...
	<?php
        ...
        try {
            ...
            $mail->SMTPSecure = false;  //tls;                            // Enable TLS encryption, `ssl` also accepted
            $mail->SMTPAutoTLS = false;
            $mail->Port =  25;//465;                                    // TCP port to connect to

            //Recipients
            $mail->setFrom('admissions@nitpyphdadmissions.in', 'NITPY PHD Admission');
            ...
            $mail->Body    = 'Your Application has been submitted and your Application Number is <b>'.$application_no.'</b><br/><br/><b>Keep the Application Number with you for Downloading your Application.</b>';
